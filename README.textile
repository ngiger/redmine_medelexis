...
@set -x RAILS_ENV developmen; bundle exec rake db:data:load@ # loads db/data.yml
...
* @set -x RAILS_ENV test; bundle exec rake redmine:plugins:test NAME=redmine_medelexis @ # runs all tests
