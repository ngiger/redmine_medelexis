...
bundle exec rake RAILS_ENV=c redmine:plugins NAME=redmine_contacts
bundle exec rake RAILS_ENV=test redmine:plugins NAME=redmine_contacts_helpdesk
bundle exec rake RAILS_ENV=test redmine:plugins NAME=redmine_products
bundle exec rake RAILS_ENV=test redmine:plugins NAME=redmine_contacts_invoices

Run tests

* @RAILS_ENV=test bundle exec rake redmine:plugins:test NAME=redmine_medelexis@ # runs all tests
* @RAILS_ENV=test bundle exec ruby script/rails runner plugins/redmine_medelexis/test/functional/license_test.rb@ # runs a single test
