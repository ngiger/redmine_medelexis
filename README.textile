...
To run the tests call @rake redmine:plugins:test NAME=redmine_medelexis@, which runs the test for all installed plugins. Run tests for redmine_medelexis-plugins using @rake redmine:plugins:test NAME=redmine_medelexis@
