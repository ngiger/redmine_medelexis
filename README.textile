...
Run tests (assuming a bash shell) for redmine_medelexis-plugins using
* @RAILS_ENV=test bundle exec rake redmine:plugins:test NAME=redmine_medelexis@
* @RAILS_ENV=test bundle exec ruby plugins/redmine_medelexis/test/functional/license_test.rb@
* @RAILS_ENV=test bundle exec ruby plugins/redmine_medelexis/test/integration/license_test.rb@
